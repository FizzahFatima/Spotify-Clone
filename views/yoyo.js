...
const songs = [
    {
        id:1,
        songName: `Laal Pari<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/1.jpg"
    },
    {
        id:2,
        songName: `Millionaire<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/2.jpg"
    },
    {
        id:3,
        songName: `Payal<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/3.jpg"
    },
    {
        id:4,
        songName: `Blue Eyes<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/4.jpg"
    },
    {
        id:5,
        songName: `Brown Rang<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/5.jpg"
    },
    {
        id:6,
        songName: `love Dose<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/6.jpg"
    },
    {
        id:7,
        songName: `Maniac<br><span class="subtitle">Yoyo Honey Singh</span>`,
        poster: "img/Yoyo/7.jpg"
    },
    {
        id:8,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        index = el.target.id;
        music.src = `Audio/Yoyo/${index}.mpeg`;
        poster_master_play.src = `img/Yoyo/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');

        download.href = `Audio/Yoyo/${index}.mpeg`;
