...
const songs = [
    {
        id:1,
        songName: `Mohobbat Thi Kya Ye Bata De<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/1.jpg"
    },
    {
        id:2,
        songName: `Heer<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/2.jpg"
    },
    {
        id:3,
        songName: `Jugnu<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/3.jpg"
    },
    {
        id:4,
        songName: `Teri Yaadein Kyun<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/4.jpg"
    },
    {
        id:5,
        songName: `Bechara<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/5.jpg"
    },
    {
        id:6,
        songName: `Dil Mera Naraz Hy<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/6.jpg"
    },
    {
        id:7,
        songName: `Saza<br><span class="subtitle">Shehryar Rehan</span>`,
        poster: "img/Shehryar/7.jpg"
    },
    {
        id:8,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        index = el.target.id;
        music.src = `Audio/Shehryar/${index}.mpeg`;
        poster_master_play.src = `img/Shehryar/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');

        download.href = `Audio/Shehryar/${index}.mpeg`;
