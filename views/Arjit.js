...
const songs = [
    {
        id:1,
        songName: `Tujhy Kitna Chahne Lage<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/1.jpg"
    },
    {
        id:2,
        songName: `Zaalima<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/2.jpg"
    },
    {
        id:3,
        songName: `Kalank<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/3.jpg"
    },
    {
        id:4,
        songName: `Sajni<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/4.jpg"
    },
    {
        id:5,
        songName: `Jhol<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/5.jpg"
    },
    {
        id:6,
        songName: `Zamaana Lage<br><span class="subtitle">Arijit Singh</span>`,
        poster: "img/Arijit/6.jpg"
    },
    {
        id:7,
        songName: `Dil Nu<br><span class="subtitle">Arijit Singh</span>`,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        index = el.target.id;
        music.src = `Audio/Arijit/${index}.mpeg`;
        poster_master_play.src = `img/Arijit/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');

        download.href = `Audio/Arijit/${index}.mpeg`;
