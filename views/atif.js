...
const songs = [
    {
        id:1,
        songName: `Jeena Jeena<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/1.jpg"
    },
    {
        id:2,
        songName: `Ay Dil Tu Bta<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/2.jpg"
    },
    {
        id:3,
        songName: `Hona Tha Pyar<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/3.jpg"
    },
    {
        id:4,
        songName: `Pehli Dafa<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/4.jpg"
    },
    {
        id:5,
        songName: `Tere Sang Yaraa<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/5.jpg"
    },
    {
        id:6,
        songName: `O Saathi<br><span class="subtitle">Atif Aslam</span>`,
        poster: "img/Atif/6.jpg"
    },
    {
        id:7,
        songName: `Kiya Hua Tera Wadaa<br><span class="subtitle">Atif Aslam</span>`,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        index = el.target.id;
        music.src = `Audio/Atif/${index}.mpeg`;
        poster_master_play.src = `img/Atif/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');

        download.href = `Audio/Atif/${index}.mpeg`;
