...
const songs = [
    {
        id:1,
        songName: `Ye Tune Kya Kiya<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/1.jpg"
    },
    {
        id:2,
        songName: `O Maahi<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/2.jpg"
    },
    {
        id:3,
        songName: `Tum Se Hi<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/3.jpg"
    },
    {
        id:4,
        songName: `Kesariya<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/4.jpg"
    },
    {
        id:5,
        songName: `Ve Kamleya<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/5.jpg"
    },
    {
        id:6,
        songName: `Zamanna Lage<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/6.jpg"
    },
    {
        id:7,
        songName: `Shayad<br><span class="subtitle">Pritam</span>`,
        poster: "img/Pritam/7.jpg"
    },
    {
        id:8,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e) =>{
    e.addEventListener('click', (el) =>{
        index = el.target.id;
        music.src = `Audio/Pritam/${index}.mpeg`;
        poster_master_play.src = `img/Pritam/${index}.jpg`;
        music.play();
        masterPlay.classList.add('bi-pause-fill');
        masterPlay.classList.remove('bi-play-fill');

        download.href = `Audio/Pritam/${index}.mpeg`;
